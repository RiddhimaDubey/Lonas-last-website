...
import { 
  ...
  faCloud, faMobileScreen, faGamepad, faBrain, faUsers,
  faGraduationCap, faBook, faTools, faChartBar, faComments
  ...
  const handleCheckboxChange = (e) => {
    ...
    setFormData(prevData => {
      const newTrainingNeeds = checked 
        ...
        : prevData.trainingNeeds.filter(need => need !== value);
      return {
        ...prevData,
        ...
        {submitSuccess ? (
          ...
          <form onSubmit={handleSubmit} style={{ display: 'grid', gap: '1.5rem' }}>
            ...
            <div className="form-group">
              ...
              >
                {[
                  { id: 'tech-skills', label: 'Technical Skills', icon: faCode, color: '#2ed573' },
                  { id: 'soft-skills', label: 'Soft Skills', icon: faUsers, color: '#7bed9f' },
                  { id: 'leadership', label: 'Leadership', icon: faGraduationCap, color: '#70a1ff' },
                  { id: 'data-analytics', label: 'Data Analytics', icon: faChartBar, color: '#ffa502' },
                  { id: 'ai-ml', label: 'AI/ML Training', icon: faBrain, color: '#ff4757' },
                  { id: 'cybersecurity', label: 'Cybersecurity', icon: faShieldHalved, color: '#ff6b81' },
                  { id: 'cloud-computing', label: 'Cloud Computing', icon: faCloud, color: '#54a0ff' },
                  { id: 'digital-transformation', label: 'Digital Transformation', icon: faTools, color: '#ff9ff3' },
                  { id: 'communication', label: 'Communication Skills', icon: faComments, color: '#ff4757' },
                  { id: 'project-management', label: 'Project Management', icon: faChartLine, color: '#00c2ff' },
                  { id: 'innovation', label: 'Innovation & Creativity', icon: faLightbulb, color: '#2ed573' },
                  { id: 'business-skills', label: 'Business Skills', icon: faBriefcase, color: '#ffa502' }
                ].map((need, index) => (
                  <motion.div
                    key={need.id}
                  ...
                  >
                    <motion.div
                      style={{
                        ...
                        opacity: formData.trainingNeeds.includes(need.label) ? 1 : 0,
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', width: '100%', zIndex: 1 }}>
                      <input
                        ...
                        name="trainingNeeds"
                        value={need.label}
                        checked={formData.trainingNeeds.includes(need.label)}
                      ...
                      <FontAwesomeIcon 
                        ...
                        style={{
                          ...
                          fontSize: '1.1rem',
                          color: need.color,
                          opacity: formData.trainingNeeds.includes(need.label) ? 1 : 0.7,
                          transition: 'all 0.3s ease'
                        }}
                      />
                      <label
