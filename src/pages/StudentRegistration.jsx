            ...
            <div style={{ marginBottom: '1.5rem' }}>
              ...
              >
                {[
                  ...
                  { id: 'data-science', label: 'Data Science', icon: faDatabase, color: '#ff4757' },
                  { id: 'ai-ml', label: 'AI/ML', icon: faBrain, color: '#2ed573' },
                  { id: 'web-dev', label: 'Web Development', icon: faGlobe, color: '#ffa502' },
                  { id: 'mobile-dev', label: 'Mobile Development', icon: faMobileScreen, color: '#7bed9f' },
                  ...
                  <motion.div
                    ...
                    onClick={() => {
                      const checkbox = document.getElementById(`interest-${interest.id}`);
                      if (checkbox) {
                        checkbox.click();
                      }
                    }}
                  >
                    ...
                    <motion.label
                      ...
                      whileHover={{ color: interest.color }}
                    >
                      {interest.label}
                    </motion.label>
                  </motion.div>
